...
export default function FriendRequestList({ requests, onRequestUpdate }: FriendRequestListProps) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Badge variant="secondary">받은 요청</Badge>
            <span className="text-sm text-gray-500">({requests.length})</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-center text-gray-500 py-8">받은 친구 요청이 없습니다.</p>
        </CardContent>
      </Card>
    )
  }
